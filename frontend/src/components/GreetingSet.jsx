                    ...
                    <th scope="col" className="px-5 py-3 text-sm font-normal text-left text-gray-800 uppercase bg-white border-b border-gray-200 flex justify-end">
                        <div className="relative inline-block w-9 align-middle select-none">
                            <input type="checkbox" name="toggle" id="check-start"
                                className="checked:bg-blue-500 outline-none focus:outline-none right-4 checked:right-0 duration-200 ease-in absolute block w-5 h-5 rounded-full bg-white border-4 appearance-none cursor-pointer"
            ...
            <tbody>
                <tr>
                    <td className="px-5 py-5 text-sm" colSpan="2">
                        <textarea name="" id="" cols="30" rows="5" className="block w-full border-gray-300 shadow-sm focus:border-blue-500 focus:ring-0 sm:text-sm" placeholder="Welcome to bot..." value={greetingMessage} onChange={(e) => setGreetingMessage(e.target.value)}></textarea>
